...
import 'package:my_app/ui/my/about_page.dart';
...
class MyPageState extends State<MyPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(flexibleSpace: _headWidget(), toolbarHeight: 80),
  ...
  Widget _infoWidget() {
    return Container(
      ...
      margin: EdgeInsets.only(
          top: MyDimens.getHeight(20),
          left: MyDimens.getWidth(16),
          right: MyDimens.getWidth(16),
          bottom: MyDimens.getHeight(10)),
      padding: EdgeInsets.symmetric(
          vertical: MyDimens.getHeight(10), horizontal: MyDimens.getWidth(16)),
      ...
      child: Column(
        children: [
          ...
          Ink(
            child: InkWell(
              onTap:() {
                RouteUtil.startActivity(context, AboutPage());
              },
              child: Container(
                padding: EdgeInsets.only(
                    top: MyDimens.getHeight(10),
                ...
                if (i != null) {
                  if (i == 1) {
                    Provider.of<CurrentLocale>(context, listen: false)
                        .setLocale('zh'); //更改语言
                    Fluttertoast.showToast(msg: S.of(context).restart);
                  } else {
                    Provider.of<CurrentLocale>(context, listen: false)
                        .setLocale('en');
                    Fluttertoast.showToast(msg: S.of(context).restart);
          ...
          Ink(
            child: InkWell(
              onTap: () {
                Fluttertoast.showToast(msg: "上线才能分享，不写了，不受这气");
              },
              child: Container(
                padding: EdgeInsets.only(
                    top: MyDimens.getHeight(10),
    ...
    return GestureDetector(
      ...
      child: Container(
          ...
          decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.all(Radius.circular(10))),
          margin: EdgeInsets.symmetric(
              vertical: MyDimens.getHeight(10),
              horizontal: MyDimens.getWidth(16)),
          padding: EdgeInsets.only(
            top: MyDimens.getHeight(10),
            bottom: MyDimens.getHeight(10),
          ),
